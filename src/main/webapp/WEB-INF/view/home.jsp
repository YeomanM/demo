...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-main mag0">
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" id="userInfo">
                    <a href="javascript:;"><img src="images/logo.png" class="layui-nav-img userAvatar" width="35" height="35"><cite class="adminName">驊驊龔頾</cite></a>
                    <dl class="layui-nav-child">
    ...
    <div class="layui-footer footer">
        <p><span>copyright @2018 layuicms</span></p>
    </div>
</div>
    ...
    layui.use(['form','layer','table','laytpl'],function(){
        var form = layui.form,
            ...
            success:function (data) {
                window.localStorage.setItem("right",data.data);
            }
        })
    })
